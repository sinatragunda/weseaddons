...
public class LoanProduct{
    ...
    public LoanProduct(long id , String name , double minPrincipal , double maxPrincipal ,double interestRatePerPeriod , int repaymentsEvery ,int numberOfRepayments ,int amortizationType ,int interestType ,int interestCalculationPeriodType ,int transactionProcessingStrategyId ,int repaymentFrequencyType){
        this.id = id ;
        this.name = name ;
